...
public final class switchperspective_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 *******************************************************************************/
      ...
      out.print(response.encodeURL(controller.getPathWithContext(controller.getCurrentPerspective().getPerspectiveContentPage())));
      out.write("\";\n");
      out.write("</script>\n");
      out.write("</body>\n");
      out.write("</html>\n");
