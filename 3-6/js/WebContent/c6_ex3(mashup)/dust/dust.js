...
function parsing() {
    ...
    $.ajax({
        url:"http://203.247.66.146/iros/RetrieveWhoIndexService/getAsthmaWhoList?ServiceKey=" +
        "55N1hQHeereP8lF51%2BpHC00GZ8DmJIhjTQlTsvEgYbixuNLHq%2Bu8BAiLmzMN1eJYp9EAlcdamPbuPVpAov0XHA%3D%3D&AreaNo="
        +AreaNo,
        type: 'GET',
        dataType:"xml",
        success: infl 
